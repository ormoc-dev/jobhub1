...
$stmt = $pdo->prepare("
    SELECT us.*, sp.plan_name, sp.plan_type, sp.price, sp.description,
           u.email, u.username,
           ep.first_name, ep.last_name, ep.middle_name, 
           ep.contact_no, ep.address, ep.employee_id
...
$fullName = trim(($subscription['first_name'] ?? '') . ' ' . ($subscription['middle_name'] ?? '') . ' ' . ($subscription['last_name'] ?? ''));
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <div class="receipt-container">
        ...
        <div class="receipt-info">
            <div class="info-section">
                <h3>Bill To:</h3>
                <p><strong><?php echo htmlspecialchars($fullName ?: 'N/A'); ?></strong></p>
                <p>Employee ID: <?php echo htmlspecialchars($subscription['employee_id'] ?? 'N/A'); ?></p>
                <p><?php echo htmlspecialchars($subscription['email']); ?></p>
                <p><?php echo htmlspecialchars($subscription['contact_no'] ?? 'N/A'); ?></p>
                <?php if ($subscription['address']): ?>
                    <p><?php echo htmlspecialchars($subscription['address']); ?></p>
                <?php endif; ?>
            </div>
            <div class="info-section">
