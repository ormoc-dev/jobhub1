...
<head>
    ...
    <title>View Message - WORKLINK</title>
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <h5 class="mb-0">
                                ...
                                <?php else: ?>
                                    ...
                                    <?php elseif ($message['other_party_role'] == 'admin'): ?>
                                        <i class="fas fa-shield-alt text-danger me-1"></i>
                                    <?php endif; ?>
                                    From <?php echo htmlspecialchars($message['other_party_name']); ?>
                                <?php endif; ?>
                            </h5>
                            <span class="badge bg-<?php echo $message['other_party_role'] == 'admin' ? 'danger' : 'success'; ?>">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <small class="text-muted"><?php echo timeAgo($message['sent_date']); ?></small>
                        </div>
